...
\section{Problème du voyageur de commerce (Traveling Salesman Problem)}to be filled later.

to be filled later.. Les premières études du problème remontent au $18$\up{ème} siècle  avec les travaux d'Hamilton et Kirkman \parencite{davendra_traveling_2010}. to be filled later. \parencite{gutin_traveling_2006}. to be filled later.
